...
CC endpoints 0/127 deliberately isolate scheduling from PLU-894's independent
integer reconstruction defect; this test does not certify that defect fixed.
